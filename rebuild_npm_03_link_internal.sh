...
rm -fr ${DIR_ROOT}/own_modules/habr-cvsn-mod-func
rm -fr ${DIR_ROOT}/own_modules/habr-cvsn-mod-base

echo "Clone dependencies from github to inner folders."
git clone https://github.com/flancer64/habr-cvsn-mod-func.git ${DIR_ROOT}/own_modules/habr-cvsn-mod-func
git clone https://github.com/flancer64/habr-cvsn-mod-base.git ${DIR_ROOT}/own_modules/habr-cvsn-mod-base

echo "Link dependencies to '/usr/lib/node_modules/'."
cd ${DIR_ROOT}/own_modules/habr-cvsn-mod-base
sudo npm link
cd ${DIR_ROOT}/own_modules/habr-cvsn-mod-func
sudo npm link
